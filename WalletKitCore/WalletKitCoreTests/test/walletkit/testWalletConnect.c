...
runSigningTest(
    ...
    // testMessage: "My email is john@doe.com - Tue, 14 Sep 2021 13:47:59 GMT";
    const char* testMsg = "0x4d7920656d61696c206973206a6f686e40646f652e636f6d202d205475652c2031342053657020323032312031333a34373a353920474d54";
    ...
    // Get a digest of the standard message
    *digestLength = 0;
    *digest = wkWalletConnectorGetDigest(walletConnector,
    ...
    printf ("    Created digest length %lu\n", *digestLength);
    ...
    *signature = wkWalletConnectorSignData(walletConnector,
    ...
    printf ("    Created signature of length %lu of standard message\n", *signatureLength);
...
runRecoverTest(
    ...
    WKKey originalSigningKey = wkWalletConnectorCreateKey (walletConnector,
                                                          testPaperKey,
                                                          &status);
