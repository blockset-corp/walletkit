...
typedef struct Proto__Timestamp Proto__Timestamp;
typedef struct Proto__TimestampSeconds Proto__TimestampSeconds;
 ...
 */
struct  Proto__TimestampSeconds
{
  ProtobufCMessage base;
  /*
   * Number of complete seconds since the start of the epoch
