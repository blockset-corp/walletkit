...
typedef struct Proto__Transaction Proto__Transaction;
...
struct  Proto__Transaction
{
   ...
   */
  Proto__SignatureMap *sigmap PROTOBUF_C__DEPRECATED;
  /*
   * TransactionBody serialized into bytes, which needs to be signed
   */
  ProtobufCBinaryData bodybytes PROTOBUF_C__DEPRECATED;
  /*
   * SignedTransaction serialized into bytes
   */
  ProtobufCBinaryData signedtransactionbytes;
};
