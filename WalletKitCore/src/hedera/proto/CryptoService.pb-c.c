...
static const ProtobufCMethodDescriptor proto__crypto_service__method_descriptors[14] =
{
  ...
  { "addLiveHash", &proto__transaction__descriptor, &proto__transaction_response__descriptor },
  { "deleteLiveHash", &proto__transaction__descriptor, &proto__transaction_response__descriptor },
  { "getLiveHash", &proto__query__descriptor, &proto__response__descriptor },
