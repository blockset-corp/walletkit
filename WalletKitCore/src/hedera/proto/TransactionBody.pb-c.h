...
typedef enum {
  ...
  PROTO__TRANSACTION_BODY__DATA_WK_ADD_CLAIM = 10,
  PROTO__TRANSACTION_BODY__DATA_WK_CREATE_ACCOUNT = 11,
  PROTO__TRANSACTION_BODY__DATA_WK_DELETE = 12,
  PROTO__TRANSACTION_BODY__DATA_WK_DELETE_CLAIM = 13,
  PROTO__TRANSACTION_BODY__DATA_WK_TRANSFER = 14,
  PROTO__TRANSACTION_BODY__DATA_WK_UPDATE_ACCOUNT = 15,
