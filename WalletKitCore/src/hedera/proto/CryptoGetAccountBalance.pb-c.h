...
typedef struct Proto__CryptoGetAccountBalanceQuery Proto__CryptoGetAccountBalanceQuery;
typedef struct Proto__CryptoGetAccountBalanceResponse Proto__CryptoGetAccountBalanceResponse;
...
typedef enum {
  PROTO__CRYPTO_GET_ACCOUNT_BALANCE_QUERY__BALANCE_SOURCE__NOT_SET = 0,
  PROTO__CRYPTO_GET_ACCOUNT_BALANCE_QUERY__BALANCE_SOURCE_ACCOUNT_ID = 2,
  PROTO__CRYPTO_GET_ACCOUNT_BALANCE_QUERY__BALANCE_SOURCE_CONTRACT_ID = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(PROTO__CRYPTO_GET_ACCOUNT_BALANCE_QUERY__BALANCE_SOURCE__CASE)
} Proto__CryptoGetAccountBalanceQuery__BalanceSourceCase;
 ...
 */
struct  Proto__CryptoGetAccountBalanceQuery
{
  ...
  Proto__CryptoGetAccountBalanceQuery__BalanceSourceCase balance_source_case;
  union {
    /*
...
#define PROTO__CRYPTO_GET_ACCOUNT_BALANCE_QUERY__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&proto__crypto_get_account_balance_query__descriptor) \
    , NULL, PROTO__CRYPTO_GET_ACCOUNT_BALANCE_QUERY__BALANCE_SOURCE__NOT_SET, {0} }


/*
 * Response when the client sends the node CryptoGetAccountBalanceQuery 
 */
struct  Proto__CryptoGetAccountBalanceResponse
{
  ProtobufCMessage base;
  /*
