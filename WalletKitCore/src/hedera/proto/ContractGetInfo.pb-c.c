...
static const ProtobufCFieldDescriptor proto__contract_get_info_response__contract_info__field_descriptors[11] =
{
  {
    "contractID",
    1,
  ...
  },
  {
    ...
    0,   /* quantifier_offset */
    offsetof(Proto__ContractGetInfoResponse__ContractInfo, balance),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    0,   /* quantifier_offset */
    offsetof(Proto__ContractGetInfoResponse__ContractInfo, deleted),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_MESSAGE,
    offsetof(Proto__ContractGetInfoResponse__ContractInfo, n_tokenrelationships),
    offsetof(Proto__ContractGetInfoResponse__ContractInfo, tokenrelationships),
...
static const unsigned proto__contract_get_info_response__contract_info__field_indices_by_name[] = {
  ...
  7,   /* field[7] = memo */
  6,   /* field[6] = storage */
  10,   /* field[10] = tokenRelationships */
};
