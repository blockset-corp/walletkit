...
static const char *bsvMainNetDNSSeeds[] = {
    "seed.bitcoinsv.io",
    "seed.cascharia.com",
...
static const char *bsvTestNetDNSSeeds[] = {
...
static const BRBitcoinMerkleBlock *_medianBlock(const BRBitcoinMerkleBlock *b, const BRSet *blockSet)
{
    const BRBitcoinMerkleBlock *b0 = NULL, *b1 = NULL, *b2 = b;
...
static int bsvMainNetVerifyDifficulty(const BRBitcoinMerkleBlock *block, const BRSet *blockSet)
{
...
static BRBitcoinChainParams bsvMainNetParamsRecord = {
    bsvMainNetDNSSeeds,
    8333,                // standardPort
    0xe8f3e1e3,          // magicNumber
    SERVICES_NODE_BCASH, // services
    bsvMainNetVerifyDifficulty,
    NULL,
    0,
...
static void bsvChainParamsInit(void) {

    // BSV MainNet

    // blockchain checkpoints - these are also used as starting points for partial chain downloads, so they must be at
    // difficulty transition boundaries in order to verify the block difficulty at the immediately following transition
    BRBitcoinCheckPoint bsvMainNetCheckpoints[] = {
        ...
        { 556767, uint256("000000000000000001d956714215d96ffc00e0afda4cd0a96c96f8d802b1662b"), 1542305817, 0x18021fdb }, // BSV Hard Fork vv
        ...
        { 685440, uint256("00000000000000000126ec95e8ab02202e2b69c279086678d3383b5afef3dc2c"), 1619985660, 0x180a189b },
        { 705600, uint256("00000000000000000ef2f7578d64ddb6f5ced29b300b9c2de5eee530eaa96ea6"), 1632157680, 0x1812d6cb }
        // 725760
        // 745920
    ...
    bsvMainNetParamsRecord.checkpointsCount = sizeof(bsvMainNetCheckpoints) / sizeof(BRBitcoinCheckPoint);
    bsvMainNetParamsRecord.checkpoints = calloc (bsvMainNetParamsRecord.checkpointsCount, sizeof(BRBitcoinCheckPoint));
    memcpy ((BRBitcoinCheckPoint *) bsvMainNetParamsRecord.checkpoints,
            bsvMainNetCheckpoints,
            sizeof(bsvMainNetCheckpoints));

    // BSV TestNet

    BRBitcoinCheckPoint bsvTestNetCheckpoints[] = {
        ...
        { 1267996, uint256("00000000000001fae0095cd4bea16f1ce8ab63f3f660a03c6d8171485f484b24"), 1542301205, 0x1a071b86 }, // BSV Hard Fork vv
        { 1310400, uint256("00000000000061681e3ea8822abecd076fcb38ac45900107d6bf48a2abe6811f"), 1562460976, 0x1d00ffff },
        { 1411200, uint256("00000000000002420f91302b304e2953bb796bfab184ba6e73d0faf0057fd69d"), 1614033698, 0x1a024d19 }
        // 1512000
    };

    // Initialize bsv testnet checkpoints
    bsvTestNetParamsRecord.checkpointsCount = sizeof(bsvTestNetCheckpoints) / sizeof(BRBitcoinCheckPoint);
    bsvTestNetParamsRecord.checkpoints = calloc (bsvTestNetParamsRecord.checkpointsCount, sizeof(BRBitcoinCheckPoint));
    memcpy ((BRBitcoinCheckPoint *) bsvTestNetParamsRecord.checkpoints,
            bsvTestNetCheckpoints,
            sizeof(bsvTestNetCheckpoints));
}

// Run once initializer guarantees
static pthread_once_t bsvChainParamsInitOnce = PTHREAD_ONCE_INIT;

const BRBitcoinChainParams *bsvChainParams(bool mainnet) {
    pthread_once (&bsvChainParamsInitOnce, bsvChainParamsInit);
    return (mainnet ? &bsvMainNetParamsRecord : &bsvTestNetParamsRecord);
}
