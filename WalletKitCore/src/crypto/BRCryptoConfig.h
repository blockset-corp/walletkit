...
DEFINE_NETWORK (CRYPTO_NETWORK_TYPE_BTC,  "bitcoin-mainnet", NETWORK_NAME, "mainnet", true, 612691, 6, 10 * 60)
...
DEFINE_NETWORK (CRYPTO_NETWORK_TYPE_BTC,  "bitcoin-testnet", NETWORK_NAME, "testnet", false, 1660401, 6, 10 * 60)
...
DEFINE_NETWORK (CRYPTO_NETWORK_TYPE_BCH,  "bitcoincash-testnet", NETWORK_NAME, "testnet", false, 1353306, 6, 10 * 60)
...
DEFINE_NETWORK (CRYPTO_NETWORK_TYPE_ETH,  "ethereum-mainnet", NETWORK_NAME, "mainnet", true, 9273958, 6, 15)
...
DEFINE_NETWORK (CRYPTO_NETWORK_TYPE_XRP,  "ripple-mainnet", NETWORK_NAME, "mainnet", true, 52713481, 6, 5)
