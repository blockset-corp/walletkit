...
class WKAmountTests: XCTestCase {
...
//        XCTAssertNotEqual("wei123,456,789,012,345,678", a7?.string(as: ETH_WEI)!)
    ...
    func testAmountExtended () {
        ...
        let BTC_SATOSHI = WalletKit.Unit (currency: btc, code: "BTC-SAT",   name: "Satoshi",  symbol: "SAT")
        let BTC_MONGO   = WalletKit.Unit (currency: btc, code: "BTC-MONGO", name: "BitMongo", symbol: "BM", base: BTC_SATOSHI, decimals: 70)
    ...
    func testCurrencyPair () {
        ...
        let usd_cents  = WalletKit.Unit (currency: usd, code: "USD-Cents", name: "Cents", symbol: "c")
        let usd_dollar = WalletKit.Unit (currency: usd, code: "USD-Dollar", name: "Dollars", symbol: "$", base: usd_cents, decimals: 2)
