...
public class WKPayProtReqBitPayAndBip70Callbacks extends Structure {
    ...
    public interface BitPayAndBip70Validator extends BRCryptoPayProtReqBitPayAndBip70Validator {
        WKPaymentProtocolError handle (WKPaymentProtocolRequest request,
                                       Cookie cookie,
                                       String pkiType,
                                       long expires,
        ...
        default int callback(Pointer request,
                             ...
                             SizeT sigLen) {
            return handle(
                    new WKPaymentProtocolRequest(request),
                    new Cookie(cookie),
                    pkiType,
                    expires,
    ...
    public interface BitPayAndBip70CommonNameExtractor extends BRCryptoPayProtReqBitPayAndBip70CommonNameExtractor {
        Optional<String> handle(WKPaymentProtocolRequest request,
                                Cookie cookie,
                                String pkiType,
    ...
    public WKPayProtReqBitPayAndBip70Callbacks(Pointer peer) {
        super(peer);
    }

    public WKPayProtReqBitPayAndBip70Callbacks(Pointer context,
