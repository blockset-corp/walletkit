...
import com.blockset.walletkit.brd.Hasher;
...
public class HasherAIT {
    ...
    public void testHasher() {
        ...
        assertArrayEquals(a, Hasher.createForAlgorithm(com.blockset.walletkit.Hasher.Algorithm.SHA1).hash(d).get());
        ...
        assertArrayEquals(a, Hasher.createForAlgorithm(com.blockset.walletkit.Hasher.Algorithm.SHA256).hash(d).get());
        ...
        assertArrayEquals(a, Hasher.createForAlgorithm(com.blockset.walletkit.Hasher.Algorithm.SHA256_2).hash(d).get());
        ...
        assertArrayEquals(a, Hasher.createForAlgorithm(com.blockset.walletkit.Hasher.Algorithm.SHA224).hash(d).get());
        ...
        assertArrayEquals(a, Hasher.createForAlgorithm(com.blockset.walletkit.Hasher.Algorithm.SHA384).hash(d).get());
        ...
        assertArrayEquals(a, Hasher.createForAlgorithm(com.blockset.walletkit.Hasher.Algorithm.SHA512).hash(d).get());
        ...
        assertArrayEquals(a, Hasher.createForAlgorithm(com.blockset.walletkit.Hasher.Algorithm.SHA3).hash(d).get());
        ...
        assertArrayEquals(a, Hasher.createForAlgorithm(com.blockset.walletkit.Hasher.Algorithm.RMD160).hash(d).get());
        ...
        assertArrayEquals(a, Hasher.createForAlgorithm(com.blockset.walletkit.Hasher.Algorithm.HASH160).hash(d).get());
        ...
        assertArrayEquals(a, Hasher.createForAlgorithm(com.blockset.walletkit.Hasher.Algorithm.KECCAK256).hash(d).get());
        ...
        assertArrayEquals(a, Hasher.createForAlgorithm(com.blockset.walletkit.Hasher.Algorithm.MD5).hash(d).get());
    }
}
